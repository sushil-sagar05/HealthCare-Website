...
function ChatBot() {
  ...
  <div className={`chatbot fixed p-5 right-0 top-52 w-[20vw] h-[50vh] bg-white shadow-md rounded-md ${activeBot ? "translate-x-full" : "translate-x-0"} transition-all duration-500 z-50`} >
   <div className='flex '>
   <span className='font-semibold w-[20vw] '>Help Bot</span>
   ...
   <div className="contentCard h-[40vh] bg-[#f8f7f5]">
        <div className="questions flex gap-3 pt-5 bg-[] ">
