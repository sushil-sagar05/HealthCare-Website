...
function AboutUs() {
  ...
  <>
  <Header/>
  <div className="container h-[55vh] w-[100vw] ">
  
  <Slider {...settings}> {
    Data.map((e) => (
      <>
      <div className="img h-[55vh] w-[100vw]  shadow-md">
    <img className='h-[55vh] w-[100vw] shadow-md ' src={e.img} alt="" />
    </div> 
      </>
    ))
   }
  ...
  <div className="About  h-[10vh] w-[20vw]">
    <h2 className='font-extrabold text-3xl pt-3'>About Us</h2>
  </div>
  <div className='ml-20'><hr /></div>
  
  <div className="content h-[55vh] w-[75vw] ">
    
    <p className='px-10 text-left ml-24 text-xl mt-4 bg-[#f8f7f5]'>
...
At CareSync, we’re not just building a platform — we’re creating a seamless healthcare experience. Whether you're a patient, doctor, or hospital administrator, our goal is to provide you with the tools you need to improve healthcare outcomes across the board.<span>”</span>
    ...
    <div className="foot mt-20 ml-10 ">
