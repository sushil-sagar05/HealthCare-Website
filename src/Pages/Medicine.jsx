...
function Medicine() {
  ...
  return (
    <>
      <Header/>
      <div className="container h-[15vh] w-full">
        <div className="header">
          <h2 className='font-bold text-4xl md:text-6xl underline'>Medicine Section</h2>
          <span className='fixed right-8 md:right-32 top-20'>Available Medicine : 543</span>
        </div>
      </div>
      <Cart />
      <MedicineItems/>
